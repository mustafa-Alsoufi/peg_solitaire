...
extern void F995_7409(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 994, Current, 0, 1, 13661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 13661);
...
void F995_7409 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 994, Current, 0, 1, 13653);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
