...
extern void F996_7417(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F996_7418(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F996_7419(EIF_REFERENCE);
...
void F996_7417 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 2, 13662);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5218, 0xF8000101, 0); /* case */
	RTAR(Current, arg2);
	*(EIF_REFERENCE *)(Current + RTWA(5218, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5214, 0xF80000E7, 0); /* case_name */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(5214, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5216, 0xF80000E7, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5216, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5220, 0xF80000E7, 0); /* expected_tag_name */
	tr1 = RTMS_EX_H("NONE",4,1313820229);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5220, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 5215, 0xF80000E7, 0); /* bookmark_name */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
...
void F996_7418 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 3, 13663);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F996_7419 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 995, Current, 3, 0, 13664);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 5212, 0x04000000, 1); /* passed */
	...
	ur1 = RTCCL(tr1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5220, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur2 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(5212, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		...
		RTHOOK(7);
		RTDBGAA(Current, dtype, 5213, 0x04000000, 1); /* contract_violated */
		...
		*(EIF_REFERENCE *)(Current + RTWA(5216, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5217, 0x10000000, 1); /* violation_type */
...
EIF_TYPED_VALUE F996_7420 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 13665);
	RTSA(Dtype(Current));
	RTSC;
