...
#define ub1 ub1x.it_b
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5044, 0xF8000143, 0); /* test_classes */
	RTAR(Current, arg3);
	...
	for (;;) {
		...
		if (EIF_TEST(loc3)) {
			...
			for (;;) {
				...
				RTHOOK(16);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5209, "is_violation_case", loc4))(loc4)).it_b);
				if (tb3) {
					RTHOOK(17);
					tb3 = *(EIF_BOOLEAN *)(loc4 + RTVA(5212, "passed", loc4));
					if (tb3) {
						RTHOOK(18);
						RTDBGAA(Current, dtype, 5039, 0x10000000, 1); /* number_passed_violation */
