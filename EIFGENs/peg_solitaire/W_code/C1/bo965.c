...
extern void F965_7796(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 964, Current, 0, 0, 13450);
	RTSA(Dtype(Current));
	RTSC;
...
void F965_7796 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 964, Current, 0, 7795);
	RTSA(dtype);
	RTME(dtype, 0);
